...
export const renderExistingBookingStage = ({ classes, registeredPhone,
...
export const renderRegisteredStage = ({ classes, registeredPhone, enterAlternatePhoneInitStage,
